                    ...
                    <form method="POST" action="{{ route('profilestore') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('looking_job') is-invalid @enderror" name="looking_job" required>
                                ...
                                <option value="Yes" {{ old('looking_job' ,$profile_data->looking_job ?? '') == 'Yes' ? 'selected' : '' }}>Yes</option>
                                <option value="No" {{ old('looking_job' ,$profile_data->looking_job ?? '') == 'No' ? 'selected' : '' }}>No</option>
                            </select>
